...
Pod::Spec.new do |s|
    ...
    s.source = {
        "http" => "https://genesysdx.jfrog.io/artifactory/genesysdx-ios.dev/GenesysCloudBot/GenesysCloudBot_version_v2.1.0.rc3_commit_e3ef67033083612508142a06f2127a7d83ad5eab.zip"
    }
