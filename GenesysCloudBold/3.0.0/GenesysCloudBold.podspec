...
Pod::Spec.new do |s|
  ...
  s.source = {
  "http" => "https://bold360ai-mobile-artifacts.s3.amazonaws.com/dx/ios/dev/GenesysCloudBold/GenesysCloudBold_version_v3.0.0.rc6_commit_471272616793bc5432602734bced9ffbfaeb67dc.zip"
  }
